...
class BearBtnComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.0.4", ngImport: i0, type: BearBtnComponent, deps: [{ token: ThemeService }], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "19.0.4", type: BearBtnComponent, isStandalone: true, selector: "bear-btn", inputs: { type: "type" }, ngImport: i0, template: "<button class=\"btn\" [ngStyle]=\"{'background-color': color, color: fontColor}\">\n    <ng-content></ng-content>\n</button>\n", styles: [".btn{font-family:Tahoma,sans-serif;font-size:1rem;font-weight:600;display:flex;align-items:center;text-align:center;height:2.8rem;padding:0 1rem;margin:0 1rem;border-radius:.5rem;border:none;transition:all .1s ease-in-out;position:relative}.btn:hover,.btn:active{filter:brightness(90%);cursor:pointer}.btn:active{transform:scale(.95)}\n"], dependencies: [{ kind: "directive", type: NgStyle, selector: "[ngStyle]", inputs: ["ngStyle"] }] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.0.4", ngImport: i0, type: BearBtnComponent, decorators: [{
            type: Component,
...
class BearInputCheckboxComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.0.4", ngImport: i0, type: BearInputCheckboxComponent, deps: [{ token: ThemeService }], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "19.0.4", type: BearInputCheckboxComponent, isStandalone: true, selector: "bear-input-checkbox", inputs: { type: "type" }, outputs: { checkedStateChange: "checkedStateChange" }, ngImport: i0, template: "<input type=\"checkbox\" class=\"checkbox\"\n       [ngStyle]=\"{'border-color': color,\n       'background-color': isChecked ? color : 'transparent',\n       'color': fontColor\n       }\"\n       (change)=\"onChecked($event)\"\n>\n", styles: [".checkbox{height:1.5rem;width:1.5rem;appearance:none;box-sizing:border-box;border:.1rem solid;border-radius:.4rem;color:#000;font:inherit;display:grid;place-content:center}.checkbox:before{content:\"\";width:1rem;height:1rem;transform:scale(0);transition:.1s transform ease-in-out;box-shadow:inset 1rem 1rem;clip-path:polygon(14% 44%,0 65%,50% 100%,100% 16%,80% 0%,43% 62%)}.checkbox:checked:before{transform:scale(1)}\n"], dependencies: [{ kind: "directive", type: NgStyle, selector: "[ngStyle]", inputs: ["ngStyle"] }] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.0.4", ngImport: i0, type: BearInputCheckboxComponent, decorators: [{
            type: Component,
